...
<div style="padding-top:50px;padding-right: 20%;padding-left: 20%;">
    <table class="table table-hover">
        ...
        <tbody>
        <c:forEach var="userInLib" items="${userInLibList}">
            <tr>
                <td>${userInLib.userId}</td>
                <td>${userInLib.timeInLib}</td>
                <td>
                    <a href="UpdateUserInLibPage?UserId=${userInLib.userId}">
                        <button type="button" class="btn btn-default">修改</button>
                    </a>
                    <a href="DeleteUserInLib?UserId=${userInLib.userId}">
