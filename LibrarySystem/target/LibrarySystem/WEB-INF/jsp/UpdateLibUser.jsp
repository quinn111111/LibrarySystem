...
<div style="padding-top:10%;padding-left: 30%;padding-right: 30%;">
    <form class="form-horizontal" role="form"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="UserId" name="UserId" value="${libUser.userId}"
                       <c:if test="${flag=='update'}">readonly</c:if>
                >
            </div>
        </div>
        <div class="form-group">
            <label for="EntryTime" class="col-sm-2 control-label">入馆时间：</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="EntryTime" name="EntryTime" value="${libUser.entryTime}" required>
            </div>
        </div>
        <div class="form-group">
